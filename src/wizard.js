...
function script() {
  ...
  return [
    ...
    "   var h='\\u2705 <b>'+(r.ready||0)+' of '+(r.total||0)+'</b> listings ready'+((r.needsFixCount||0)?(' \\u00b7 \\u26A0 <b>'+r.needsFixCount+'</b> need a fix'):'')+(r.imageMatch?(' \\u00b7 <b>'+r.imageMatch.matched+'</b> got photo links'):'')+(r.hitLimit?' \\u00b7 stopped at plan limit':'');",
